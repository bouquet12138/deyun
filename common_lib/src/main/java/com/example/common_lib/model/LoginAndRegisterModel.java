...
public class LoginAndRegisterModel {
     ...
     * @param listener
     */
    public void login(String phone_num, String login_password, OnGetInfoListener<BaseBean<Integer>> listener) {

        String json = "{\"phone_num\": \"" + phone_num + "\",\"login_password\": \"" + login_password + "\"}";

        Log.d(TAG, "login: " + json);
        Log.d(TAG, "login: 地址 " + ServerInfo.getServerAddress("login"));
