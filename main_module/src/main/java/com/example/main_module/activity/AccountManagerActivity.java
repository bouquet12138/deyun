...
import com.example.baselib.util.CacheUtil;
import com.example.baselib.util.PackageUtils;
import com.example.common_lib.base.AppMvpBaseActivity;
import com.example.common_lib.contract.ARouterContract;
import com.example.main_module.R;

import static com.example.baselib.util.CacheUtil.deleteFolderFile;
...
public class AccountManagerActivity extends AppMvpBaseActivity implements View.OnClickListener {
    ...
    private void initData() {
        mCacheText.setText(CacheUtil.getCacheSize(AccountManagerActivity.this));
        mAppVersionText.setText(PackageUtils.getVersionName(AccountManagerActivity.this));
    }
