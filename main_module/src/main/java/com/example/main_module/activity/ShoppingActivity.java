...
public class ShoppingActivity extends MVPBaseActivity {

    //   mWebView.loadUrl("https://yande.qiandiancn.cn/addons/we7_wmall/template/vue/index.html?menu=#/pages/diy/index?id=336&i=3");
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.main_activity_shopping);
        initView();
        initWebView();
        initListener();
    }
