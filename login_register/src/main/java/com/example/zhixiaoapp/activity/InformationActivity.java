...
import com.example.zhixiaoapp.contract.InformationContract;
import com.example.zhixiaoapp.presenter.InformationPresenter;
...
public class InformationActivity extends SelectImagePermissionActivity
    ...
    private void initData() {
        ...
        if (bean != null) {
            ...
            mIdCard.setText(bean.getId_card());
            mBandCard.setText(bean.getBank_card());//身份证
        }
    ...
    public UserBean getModifyUserBean() {
        ...
        mModifyUserBean.setBank_card(mBandCard.getText());//银行卡号
    ...
    public void setImageBean(@NotNull ImageBean imageBean) {
        ...
        Log.d(TAG, "setImageBean: " + GsonUtil.GsonString(mModifyUserBean));
