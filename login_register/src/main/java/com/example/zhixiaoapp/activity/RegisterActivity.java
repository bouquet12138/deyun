...
import com.example.zhixiaoapp.presenter.RegisterPresenter;
...
public class RegisterActivity extends AppMvpBaseActivity implements View.OnClickListener, RegisterContract.IView {
    ...
    private void initData() {
        ...
        mVertexUser.setText(userBean.getPhone_num());
    ...
    private void initListener() {
        ...
        mMyTelPhone.setOnTextChangedListener(textChangedListener);
